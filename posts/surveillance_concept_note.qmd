...
%%| fig-cap: "Current (fragmented) surveillance architecture. NICD is the de facto source-of-truth for case notifications, but the laboratory (BChE + chemical toxicology) and PIH streams do not flow into it in a structured way."
flowchart LR
    ...
    subgraph NHLS [NHLS Laboratory]
        ...
        C2[Chemical Toxicology<br/>qualitative/quantitative<br/>pesticide assays]
    end
    ...
    style C2 fill:#cce5ff,stroke:#333
...
2. **The NHLS laboratory holds two relevant data streams** — routine **BChE** activity assays and **chemical toxicology** (qualitative/quantitative pesticide assays) — neither of which feeds NICD in a structured, automated way.
