...
# Status-quo terbufos-attributable burden (no ban)
deaths_attrib_mid <- round(f_mid * N_deaths_year)
deaths_attrib_lo  <- round(f_lo  * N_deaths_year)
deaths_attrib_hi  <- round(f_hi  * N_deaths_year)
burden_attrib_mid <- round(f_mid * burden_total / 1e9, 2)

# Deaths and burden averted under the ban
deaths_avert_mid  <- round(f_mid * phi * N_deaths_year)
