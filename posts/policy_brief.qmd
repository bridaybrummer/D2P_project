...
The original single combined policy brief has been restructured into **three focused, decision-maker-facing documents**, each addressing a distinct policy question. They share a common evidence base — defined in a single iterable parameter set — and reference each other where their actions interact.
:::
...
**Headline recommendation.** Adopt the **Surveillance MVP** (NHLS→NMC IT feed + BChE auto-notification + PIH dashboard / MVD) — **~R157,000/year, ~150 deaths averted/year**.
