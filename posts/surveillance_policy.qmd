...
**The MVP ceiling (~`r sprintf("%.0f", as.numeric(pick("d_surveillance_mvp")) * 100)`% P_detect)** is bounded by the reach of formal administrative streams. Option 3 is the mechanism for going beyond it, but only after the MVP has confirmed the remaining gap is structural rather than a compliance issue within the formal system.
