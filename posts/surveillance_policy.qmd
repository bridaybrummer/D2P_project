...
| S1: PIH dashboard + MVD (+AfriTox agent name) | `r zar(as.numeric(pick("c_S1_PIH_MVD_op")))` | $\frac{1,013 + 1,158}{20,960} = 0.104$ | `r sprintf("+%.1f pp", (as.numeric(pick("d_S1_PIH_MVD")) - as.numeric(pick("d_status_quo"))) * 100)` | 1–2 wks dash / 3–9 mo MVD | [`d_S1_PIH_MVD`](../parameters_hub.qmd#tbl-detection) |
| S2: BChE auto-notify | `r zar(as.numeric(pick("c_S2_BChE_autonotify_op")))` | $\frac{1,013 + 1,779}{20,960} = 0.133$ | `r sprintf("+%.1f pp", (as.numeric(pick("d_S2_BChE_autonotify")) - as.numeric(pick("d_status_quo"))) * 100)` | 2–4 wks | [`d_S2_BChE_autonotify`](../parameters_hub.qmd#tbl-detection) |
| **S1 + S2 (Surveillance MVP)** | **`r zar(as.numeric(pick("c_surv_MVP_op")))`** | $\frac{1,013 + 1,779 + 1,158}{20,960} = 0.189$ | **`r sprintf("+%.1f pp", (as.numeric(pick("d_surveillance_mvp")) - as.numeric(pick("d_status_quo"))) * 100)`** | **12 weeks** | [`d_surveillance_mvp`](../parameters_hub.qmd#tbl-detection) |
...
| S3: Sentinel toxicology (agent attribution — distinct purpose) | `r sprintf("R%.1fM pilot → R%.1fM", round(as.numeric(pick("c_option6_pilot_year1"))/1e6,1), round(as.numeric(pick("c_option6_full_5site_annual"))/1e6,1))` | n/a (not a coverage uplift) | feeds product-banning evidence base | 6–12 mo pilot | — |
