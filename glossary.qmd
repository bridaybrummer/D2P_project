...
**SOP** — Standard Operating Procedure. A written, repeatable instruction for staff (e.g. "when an EHP receives a cluster alert, do X, Y, Z within 24 hours"). The status-quo EHP→DALRRD referral is **not** governed by an SOP, which is the gap Option 2 closes.
